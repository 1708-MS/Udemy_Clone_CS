...
namespace Udemy_WebApp.Infrastructure.Migrations
{
    ...
    [Migration("20230726134034_AddColumnUserFullNameInApplicationUserTable")]
    partial class AddColumnUserFullNameInApplicationUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.CourseImage", b =>
                {
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.CourseReview", b =>
                {
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.CourseVideo", b =>
                {
                    b.Property<int>("CourseVideoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CourseVideoId"), 1L, 1);
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Udemy_WebApp.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.CourseImage", b =>
                {
                    b.HasOne("Udemy_WebApp.Domain.Models.Course", "Course")
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.CourseReview", b =>
                {
                    ...
                    b.HasOne("Udemy_WebApp.Domain.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("CourseReviews")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Udemy_WebApp.Domain.Models.OrderHeader", "OrderHeader")
            ...
            modelBuilder.Entity("Udemy_WebApp.Domain.Models.OrderHeader", b =>
                {
                    b.HasOne("Udemy_WebApp.Domain.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
